...
object LogHandler {
    ...
    /**
     * Warning
     * Es una función que usaremos para informar de los posibles fallos que pueda tener el programa a lo largo
     * de la ejecución del mismo
     * @param message es el mensaje que le pasaremos por parametro a la hora de llamar a la función
     */
